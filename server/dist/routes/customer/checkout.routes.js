...
exports.customerCheckoutRouter.post("/checkout/create-session", (0, asyncHandler_1.asyncHandler)(async (req, res) => {
...
exports.customerCheckoutRouter.post("/checkout/confirm", (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const dbUser = await (0, auth_1.getDbUserFromReq)(req);
