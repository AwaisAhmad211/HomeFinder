...
const orders_routes_1 = require("./routes/customer/orders.routes");
const checkout_with_points_routes_1 = require("./routes/customer/checkout-with-points.routes");
const orders_routes_2 = require("./routes/admin/orders.routes");
...
async function mainEntryFunction() {
    ...
    app.get("/", (_req, res) => {
        res
            .status(200)
            .json((0, envelope_1.ok)({ message: "API server is running", docs: "/health" }));
    });
    ...
    app.use("/customer", orders_routes_1.customerOrderRouter);
    // admin routes
    app.use("/admin", product_routes_1.adminProductRouter);
    app.use("/admin", promo_routes_1.adminPromoRouter);
    app.use("/admin", orders_routes_2.adminOrderRouter);
